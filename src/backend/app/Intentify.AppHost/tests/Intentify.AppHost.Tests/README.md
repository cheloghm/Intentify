# Intentify.AppHost.Tests

## Test project scope
- Covers `Intentify.AppHost.Tests` behaviors through the test files in this folder.
...
- `dotnet test -c Debug src/backend/app/Intentify.AppHost/tests/Intentify.AppHost.Tests/Intentify.AppHost.Tests.csproj`
- `dotnet test -c Debug src/backend/app/Intentify.AppHost/tests/Intentify.AppHost.Tests/Intentify.AppHost.Tests.csproj --filter FullyQualifiedName~Intentify.AppHost`
