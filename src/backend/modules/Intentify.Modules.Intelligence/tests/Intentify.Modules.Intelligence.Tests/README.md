# Intentify.Modules.Intelligence.Tests

## Test project scope
- Covers `Intentify.Modules.Intelligence.Tests` behaviors through the test files in this folder.
...
- Test entry files currently present:
  - `GoogleAdsHistoricalMetricsProviderTests.cs`
  - `GoogleSearchProviderTests.cs`
  - `GoogleTrendsIntegrationTests.cs`
  - `GoogleTrendsProviderTests.cs`
  - `IntelligenceIntegrationTests.cs`
  - `RecurringIntelligenceRefreshOrchestratorTests.cs`
...
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Intelligence/tests/Intentify.Modules.Intelligence.Tests/Intentify.Modules.Intelligence.Tests.csproj`
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Intelligence/tests/Intentify.Modules.Intelligence.Tests/Intentify.Modules.Intelligence.Tests.csproj --filter FullyQualifiedName~Intentify.Modules.Intelligence`
