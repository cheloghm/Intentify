# Intentify.Modules.Sites.Tests

## Test project scope
- Covers `Intentify.Modules.Sites.Tests` behaviors through the test files in this folder.
...
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Sites/tests/Intentify.Modules.Sites.Tests/Intentify.Modules.Sites.Tests.csproj`
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Sites/tests/Intentify.Modules.Sites.Tests/Intentify.Modules.Sites.Tests.csproj --filter FullyQualifiedName~Intentify.Modules.Sites`
