# Intentify.Modules.Flows.Tests

## Test project scope
- Covers `Intentify.Modules.Flows.Tests` behaviors through the test files in this folder.
...
- Test entry files currently present:
  - `ExecuteFlowsForTriggerServiceTests.cs`
  - `FlowConditionEvaluatorTests.cs`
  - `FlowsIntegrationTests.cs`
...
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Flows/tests/Intentify.Modules.Flows.Tests/Intentify.Modules.Flows.Tests.csproj`
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Flows/tests/Intentify.Modules.Flows.Tests/Intentify.Modules.Flows.Tests.csproj --filter FullyQualifiedName~Intentify.Modules.Flows`
