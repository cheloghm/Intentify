...
public interface IEngageBotRepository
{
    ...
    Task<EngageBot?> UpdateSettingsAsync(Guid tenantId, Guid siteId, string name, string? primaryColor, bool? launcherVisible, CancellationToken cancellationToken = default);
}
