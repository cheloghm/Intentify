# Intentify.Modules.Leads.Tests

## Test project scope
- Covers `Intentify.Modules.Leads.Tests` behaviors through the test files in this folder.
...
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Leads/tests/Intentify.Modules.Leads.Tests/Intentify.Modules.Leads.Tests.csproj`
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Leads/tests/Intentify.Modules.Leads.Tests/Intentify.Modules.Leads.Tests.csproj --filter FullyQualifiedName~Intentify.Modules.Leads`
