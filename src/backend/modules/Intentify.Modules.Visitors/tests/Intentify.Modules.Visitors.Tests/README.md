# Intentify.Modules.Visitors.Tests

## Test project scope
- Covers `Intentify.Modules.Visitors.Tests` behaviors through the test files in this folder.
...
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Visitors/tests/Intentify.Modules.Visitors.Tests/Intentify.Modules.Visitors.Tests.csproj`
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Visitors/tests/Intentify.Modules.Visitors.Tests/Intentify.Modules.Visitors.Tests.csproj --filter FullyQualifiedName~Intentify.Modules.Visitors`
