# Intentify.Modules.Auth.Tests

## Test project scope
- Covers `Intentify.Modules.Auth.Tests` behaviors through the test files in this folder.
...
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Auth/tests/Intentify.Modules.Auth.Tests/Intentify.Modules.Auth.Tests.csproj`
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Auth/tests/Intentify.Modules.Auth.Tests/Intentify.Modules.Auth.Tests.csproj --filter FullyQualifiedName~Intentify.Modules.Auth`
