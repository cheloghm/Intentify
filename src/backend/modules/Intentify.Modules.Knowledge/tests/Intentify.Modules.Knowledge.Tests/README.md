# Intentify.Modules.Knowledge.Tests

## Test project scope
- Covers `Intentify.Modules.Knowledge.Tests` behaviors through the test files in this folder.
...
- Test entry files currently present:
  - `KnowledgeApplicationTests.cs`
  - `KnowledgeIntegrationTests.cs`
...
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Knowledge/tests/Intentify.Modules.Knowledge.Tests/Intentify.Modules.Knowledge.Tests.csproj`
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Knowledge/tests/Intentify.Modules.Knowledge.Tests/Intentify.Modules.Knowledge.Tests.csproj --filter FullyQualifiedName~Intentify.Modules.Knowledge`
