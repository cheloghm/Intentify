# Intentify.Modules.Collector.Tests

## Test project scope
- Covers `Intentify.Modules.Collector.Tests` behaviors through the test files in this folder.
...
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Collector/tests/Intentify.Modules.Collector.Tests/Intentify.Modules.Collector.Tests.csproj`
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Collector/tests/Intentify.Modules.Collector.Tests/Intentify.Modules.Collector.Tests.csproj --filter FullyQualifiedName~Intentify.Modules.Collector`
