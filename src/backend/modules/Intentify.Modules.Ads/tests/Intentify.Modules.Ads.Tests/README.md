# Intentify.Modules.Ads.Tests

## Test project scope
- Covers `Intentify.Modules.Ads.Tests` behaviors through the test files in this folder.
...
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Ads/tests/Intentify.Modules.Ads.Tests/Intentify.Modules.Ads.Tests.csproj`
- `dotnet test -c Debug src/backend/modules/Intentify.Modules.Ads/tests/Intentify.Modules.Ads.Tests/Intentify.Modules.Ads.Tests.csproj --filter FullyQualifiedName~Intentify.Modules.Ads`
