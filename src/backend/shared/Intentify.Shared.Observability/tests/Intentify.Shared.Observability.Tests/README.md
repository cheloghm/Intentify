# Intentify.Shared.Observability.Tests

## Test project scope
- Covers `Intentify.Shared.Observability.Tests` behaviors through the test files in this folder.
...
- `dotnet test -c Debug src/backend/shared/Intentify.Shared.Observability/tests/Intentify.Shared.Observability.Tests/Intentify.Shared.Observability.Tests.csproj`
- `dotnet test -c Debug src/backend/shared/Intentify.Shared.Observability/tests/Intentify.Shared.Observability.Tests/Intentify.Shared.Observability.Tests.csproj --filter FullyQualifiedName~Intentify.Shared.Observability`
