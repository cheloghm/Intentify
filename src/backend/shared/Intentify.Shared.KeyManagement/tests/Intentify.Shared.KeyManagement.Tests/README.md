# Intentify.Shared.KeyManagement.Tests

## Test project scope
- Covers `Intentify.Shared.KeyManagement.Tests` behaviors through the test files in this folder.
...
- `dotnet test -c Debug src/backend/shared/Intentify.Shared.KeyManagement/tests/Intentify.Shared.KeyManagement.Tests/Intentify.Shared.KeyManagement.Tests.csproj`
- `dotnet test -c Debug src/backend/shared/Intentify.Shared.KeyManagement/tests/Intentify.Shared.KeyManagement.Tests/Intentify.Shared.KeyManagement.Tests.csproj --filter FullyQualifiedName~Intentify.Shared.KeyManagement`
