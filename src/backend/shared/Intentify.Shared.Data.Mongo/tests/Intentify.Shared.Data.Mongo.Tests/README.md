# Intentify.Shared.Data.Mongo.Tests

## Test project scope
- Covers `Intentify.Shared.Data.Mongo.Tests` behaviors through the test files in this folder.
...
- Test entry files currently present:
  - `MongoIntegrationTests.cs`

## Important fixtures/helpers/dependencies
- `Testcontainers.MongoDb` for containerized Mongo integration coverage
...
- `dotnet test -c Debug src/backend/shared/Intentify.Shared.Data.Mongo/tests/Intentify.Shared.Data.Mongo.Tests/Intentify.Shared.Data.Mongo.Tests.csproj`
- `dotnet test -c Debug src/backend/shared/Intentify.Shared.Data.Mongo/tests/Intentify.Shared.Data.Mongo.Tests/Intentify.Shared.Data.Mongo.Tests.csproj --filter FullyQualifiedName~Intentify.Shared.Data.Mongo`
