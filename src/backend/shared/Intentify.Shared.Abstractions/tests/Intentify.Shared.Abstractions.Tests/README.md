# Intentify.Shared.Abstractions.Tests

## Test project scope
- Covers `Intentify.Shared.Abstractions.Tests` behaviors through the test files in this folder.
...
- `dotnet test -c Debug src/backend/shared/Intentify.Shared.Abstractions/tests/Intentify.Shared.Abstractions.Tests/Intentify.Shared.Abstractions.Tests.csproj`
- `dotnet test -c Debug src/backend/shared/Intentify.Shared.Abstractions/tests/Intentify.Shared.Abstractions.Tests/Intentify.Shared.Abstractions.Tests.csproj --filter FullyQualifiedName~Intentify.Shared.Abstractions`
