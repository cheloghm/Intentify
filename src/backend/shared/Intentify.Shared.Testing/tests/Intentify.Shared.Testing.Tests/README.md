# Intentify.Shared.Testing.Tests

## Test project scope
- Covers `Intentify.Shared.Testing.Tests` behaviors through the test files in this folder.
...
- Test entry files currently present:
  - `MongoContainerFixtureTests.cs`

## Important fixtures/helpers/dependencies
- `MongoDB.Driver` used by tests that interact with Mongo-backed flows
- `MongoContainerFixtureTests.cs` fixture/helper used by the test project
...
- `dotnet test -c Debug src/backend/shared/Intentify.Shared.Testing/tests/Intentify.Shared.Testing.Tests/Intentify.Shared.Testing.Tests.csproj`
- `dotnet test -c Debug src/backend/shared/Intentify.Shared.Testing/tests/Intentify.Shared.Testing.Tests/Intentify.Shared.Testing.Tests.csproj --filter FullyQualifiedName~Intentify.Shared.Testing`
