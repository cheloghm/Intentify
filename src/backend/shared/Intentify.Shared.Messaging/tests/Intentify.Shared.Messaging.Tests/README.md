# Intentify.Shared.Messaging.Tests

## Test project scope
- Covers `Intentify.Shared.Messaging.Tests` behaviors through the test files in this folder.
...
- `dotnet test -c Debug src/backend/shared/Intentify.Shared.Messaging/tests/Intentify.Shared.Messaging.Tests/Intentify.Shared.Messaging.Tests.csproj`
- `dotnet test -c Debug src/backend/shared/Intentify.Shared.Messaging/tests/Intentify.Shared.Messaging.Tests/Intentify.Shared.Messaging.Tests.csproj --filter FullyQualifiedName~Intentify.Shared.Messaging`
