# Intentify.Shared.Validation.Tests

## Test project scope
- Covers `Intentify.Shared.Validation.Tests` behaviors through the test files in this folder.
...
- `dotnet test -c Debug src/backend/shared/Intentify.Shared.Validation/tests/Intentify.Shared.Validation.Tests/Intentify.Shared.Validation.Tests.csproj`
- `dotnet test -c Debug src/backend/shared/Intentify.Shared.Validation/tests/Intentify.Shared.Validation.Tests/Intentify.Shared.Validation.Tests.csproj --filter FullyQualifiedName~Intentify.Shared.Validation`
